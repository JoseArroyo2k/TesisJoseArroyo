...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[colorlinks=true,citecolor=blue,urlcolor=cyan,bookmarks=true,linkcolor=blue,pdftitle={Tesis-nombre-alumno},pdfauthor={autor nombres}]{hyperref}
...
\usepackage{appendix}
\usepackage{float} % Añadir paquete float para la opción H
\usepackage{placeins} % Añadir paquete placeins para \FloatBarrier
